...
export  default function ToDoListDeleteConfirmation({title, onConfirm, onHide}){
    ...
    return(
        <Dialog visible={showDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }}
                header="Подтверждение" modal footer={deleteProductsDialogFooter} onHide={hideDeleteProductsDialog}>
